...
namespace TypographyRestApi.Controllers {
    ...
    public class WarehouseController : Controller {
        ...
        [HttpPost]
        public void AddComponentWarehouse(WarehouseAddComponentsBindingModel model) => warehouseLogic.AddComponent(new WarehouseBindingModel { Id = model.WarehouseId }, model.ComponentId, model.Count);
    }
}