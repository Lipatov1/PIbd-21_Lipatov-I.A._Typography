...
namespace TypographyBusinessLogic.BusinessLogics {
    public class WarehouseLogic : IWarehouseLogic {
        ...
        public void CreateOrUpdate(WarehouseBindingModel model) {
            var element = warehouseStorage.GetElement(new WarehouseBindingModel {
        ...
        public void AddComponent(WarehouseBindingModel model, int ComponentId, int Count) {
            var warehouse = warehouseStorage.GetElement(new WarehouseBindingModel {
                Id = model.Id
            });
            ...
            var component = componentStorage.GetElement(new ComponentBindingModel {
                Id = ComponentId
            });
