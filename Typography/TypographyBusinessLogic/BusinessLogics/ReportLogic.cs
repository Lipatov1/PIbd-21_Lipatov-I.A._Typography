...
namespace TypographyBusinessLogic.BusinessLogics {
    public class ReportLogic : IReportLogic {
        ...
        public ReportLogic(IPrintedStorage printedStorage, IComponentStorage componentStorage, IOrderStorage orderStorage, IWarehouseStorage warehouseStorage, AbstractSaveToExcel saveToExcel, AbstractSaveToWord saveToWord, AbstractSaveToPdf saveToPdf) {
